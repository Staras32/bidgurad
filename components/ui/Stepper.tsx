...
export function Stepper({ steps, currentStep, className }: StepperProps) {
  ...
  return (
    <ol className={cn('relative flex items-start justify-between', className)}>
      ...
      {steps.map((step, i) => {
        ...
        return (
          <li key={step.label} className="relative z-10 flex flex-col items-center gap-2">
            <div
              className={cn(
                ...
                state === 'current' && 'border-primary-600 bg-white text-primary-600',
